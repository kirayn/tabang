    ...
    /*app.run(function($rootScope,$http){
        $rootScope.addAction=function(idEntity, typeEntity, typeAction){
          $userId=window.localStorage.getItem('userId');
          $http.post(
            'app/actions.php',
            {
              ...
              //$scope.adverts[index].likes=$scope.adverts[index].likes+1;
            });
        }
    });*/
    ...
    app.controller('detailController', function($scope, $rootScope, checkLogin, addAction,  $http ,$routeParams, $location) {
      ...
      var tempNum=5;
        ...
        $cmntUrl="app/comments.php?queryId=" + $routeParams.advId + "&&postType='adv'";
        ...
        $scope.insertComment = function(){
          ...
          //upload files
            ...
            .then(function(response) {
                ...
                $http.get("app/comments.php?queryId=" + queryId).then(function(response){
                  $scope.comments = response.data;
                })
    ...
    //Homepage main menu
    app.controller('homeController', function($scope, checkLogin, $location) {
      checkLogin.check();
