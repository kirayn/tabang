...
var fqueriesedit = currentForm = new ew.Form("fqueriesedit", "edit");

// Validate form
fqueriesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($queries_edit->queryId->Required) { ?>
		...
		<?php } ?>
		<?php if ($queries_edit->topicId->Required) { ?>
		...
		<?php } ?>
		<?php if ($queries_edit->_userId->Required) { ?>
		...
		<?php } ?>
		<?php if ($queries_edit->date->Required) { ?>
		...
		<?php if ($queries_edit->status->Required) { ?>
...
fqueriesedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fqueriesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fqueriesedit.lists["x_topicId"] = <?php echo $queries_edit->topicId->Lookup->toClientList() ?>;
fqueriesedit.lists["x_topicId"].options = <?php echo JsonEncode($queries_edit->topicId->lookupOptions()) ?>;
fqueriesedit.lists["x__userId"] = <?php echo $queries_edit->_userId->Lookup->toClientList() ?>;
fqueriesedit.lists["x__userId"].options = <?php echo JsonEncode($queries_edit->_userId->lookupOptions()) ?>;
fqueriesedit.autoSuggests["x__userId"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $queries_edit->showPageHeader(); ?>
<?php
$queries_edit->showMessage();
?>
<form name="fqueriesedit" id="fqueriesedit" class="<?php echo $queries_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($queries_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $queries_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="queries">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$queries_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($queries->queryId->Visible) { // queryId ?>
	<div id="r_queryId" class="form-group row">
		<label id="elh_queries_queryId" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->queryId->caption() ?><?php echo ($queries->queryId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->queryId->cellAttributes() ?>>
...
<input type="hidden" data-table="queries" data-field="x_queryId" name="x_queryId" id="x_queryId" value="<?php echo HtmlEncode($queries->queryId->CurrentValue) ?>">
<?php echo $queries->queryId->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($queries->topicId->Visible) { // topicId ?>
	<div id="r_topicId" class="form-group row">
		<label id="elh_queries_topicId" for="x_topicId" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->topicId->caption() ?><?php echo ($queries->topicId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->topicId->cellAttributes() ?>>
...
<?php if ($queries->_userId->Visible) { // userId ?>
	<div id="r__userId" class="form-group row">
		<label id="elh_queries__userId" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->_userId->caption() ?><?php echo ($queries->_userId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->_userId->cellAttributes() ?>>
...
<script>
fqueriesedit.createAutoSuggest({"id":"x__userId","forceSelect":false});
</script>
...
<?php if ($queries->title->Visible) { // title ?>
	<div id="r_title" class="form-group row">
		<label id="elh_queries_title" for="x_title" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->title->caption() ?><?php echo ($queries->title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->title->cellAttributes() ?>>
...
<?php if ($queries->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_queries_details" for="x_details" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->details->caption() ?><?php echo ($queries->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->details->cellAttributes() ?>>
...
<?php if ($queries->date->Visible) { // date ?>
	<div id="r_date" class="form-group row">
		<label id="elh_queries_date" for="x_date" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->date->caption() ?><?php echo ($queries->date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->date->cellAttributes() ?>>
...
<?php if ($queries->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_queries_status" for="x_status" class="<?php echo $queries_edit->LeftColumnClass ?>"><?php echo $queries->status->caption() ?><?php echo ($queries->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $queries_edit->RightColumnClass ?>"><div<?php echo $queries->status->cellAttributes() ?>>
...
<?php if (!$queries_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $queries_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $queries_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$queries_edit->showPageFooter();
if (DEBUG_ENABLED)
