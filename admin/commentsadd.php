...
var fcommentsadd = currentForm = new ew.Form("fcommentsadd", "add");
...
fcommentsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($comments_add->queryId->Required) { ?>
		...
		<?php if ($comments_add->_userId->Required) { ?>
		...
		<?php if ($comments_add->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($comments_add->date->Required) { ?>
		...
		<?php if ($comments_add->image->Required) { ?>
...
fcommentsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcommentsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcommentsadd.lists["x_queryId"] = <?php echo $comments_add->queryId->Lookup->toClientList() ?>;
fcommentsadd.lists["x_queryId"].options = <?php echo JsonEncode($comments_add->queryId->lookupOptions()) ?>;
fcommentsadd.autoSuggests["x_queryId"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fcommentsadd.lists["x__userId"] = <?php echo $comments_add->_userId->Lookup->toClientList() ?>;
fcommentsadd.lists["x__userId"].options = <?php echo JsonEncode($comments_add->_userId->lookupOptions()) ?>;
fcommentsadd.autoSuggests["x__userId"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
?>
<form name="fcommentsadd" id="fcommentsadd" class="<?php echo $comments_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($comments_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $comments_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="comments">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$comments_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($comments->queryId->Visible) { // queryId ?>
	<div id="r_queryId" class="form-group row">
		<label id="elh_comments_queryId" class="<?php echo $comments_add->LeftColumnClass ?>"><?php echo $comments->queryId->caption() ?><?php echo ($comments->queryId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comments_add->RightColumnClass ?>"><div<?php echo $comments->queryId->cellAttributes() ?>>
...
<script>
fcommentsadd.createAutoSuggest({"id":"x_queryId","forceSelect":false});
</script>
...
<?php if ($comments->_userId->Visible) { // userId ?>
	<div id="r__userId" class="form-group row">
		<label id="elh_comments__userId" class="<?php echo $comments_add->LeftColumnClass ?>"><?php echo $comments->_userId->caption() ?><?php echo ($comments->_userId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comments_add->RightColumnClass ?>"><div<?php echo $comments->_userId->cellAttributes() ?>>
...
<script>
fcommentsadd.createAutoSuggest({"id":"x__userId","forceSelect":false});
</script>
...
<?php if ($comments->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_comments_details" for="x_details" class="<?php echo $comments_add->LeftColumnClass ?>"><?php echo $comments->details->caption() ?><?php echo ($comments->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comments_add->RightColumnClass ?>"><div<?php echo $comments->details->cellAttributes() ?>>
...
<?php if ($comments->date->Visible) { // date ?>
	<div id="r_date" class="form-group row">
		<label id="elh_comments_date" for="x_date" class="<?php echo $comments_add->LeftColumnClass ?>"><?php echo $comments->date->caption() ?><?php echo ($comments->date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comments_add->RightColumnClass ?>"><div<?php echo $comments->date->cellAttributes() ?>>
...
<?php if ($comments->image->Visible) { // image ?>
	<div id="r_image" class="form-group row">
		<label id="elh_comments_image" for="x_image" class="<?php echo $comments_add->LeftColumnClass ?>"><?php echo $comments->image->caption() ?><?php echo ($comments->image->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comments_add->RightColumnClass ?>"><div<?php echo $comments->image->cellAttributes() ?>>
...
<?php if (!$comments_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $comments_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $comments_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
