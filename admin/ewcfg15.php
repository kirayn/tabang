...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.5");
...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "tabelo_admin"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'pswEi1Cw9iiP0RpE'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/tabelo_admin.css"); // Project stylesheet file name
...
$PROJECT_ID = "{69E18FAC-2EFC-47EE-A765-B17249FAF990}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "tabelos", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "kirayn"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "overland"); // Administrator password
...
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "mobile");
...
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "emailid");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "`users`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`mobile` = %u)");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(`ID` = %u)");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(`emailid` = '%e')");
...
define(PROJECT_NAMESPACE . "SMTP_SECURE_OPTION", "ssl");
define(PROJECT_NAMESPACE . "SMTP_SERVER_USERNAME", "tabelo.india@gmail.com"); // SMTP server user name
define(PROJECT_NAMESPACE . "SMTP_SERVER_PASSWORD", "Overland#9"); // SMTP server password
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "tabelo.in@gmail.com"); // Sender email address
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "media/"); // Upload destination path (relative to app root)
...
define(PROJECT_NAMESPACE . "UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip"); // Allowed file extensions
