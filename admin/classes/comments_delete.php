 ...
 * Page class
 */
class comments_delete extends comments
{
	...
	// Page object name
	public $PageObjName = "comments_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("commentslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("commentslist.php"); // Return to list
			}
		}
	}
