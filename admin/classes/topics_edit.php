 ...
 * Page class
 */
class topics_edit extends topics
{
	...
	// Page object name
	public $PageObjName = "topics_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_topicId")) {
				$this->topicId->setFormValue($CurrentForm->getValue("x_topicId"));
			}
		} else {
