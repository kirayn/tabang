 ...
 * Page class
 */
class comments_edit extends comments
{
	...
	// Page object name
	public $PageObjName = "comments_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_commentId")) {
				$this->commentId->setFormValue($CurrentForm->getValue("x_commentId"));
			}
		} else {
