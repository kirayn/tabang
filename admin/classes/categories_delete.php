...
class categories_delete extends categories
{
	...
	// Page object name
	public $PageObjName = "categories_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("categorieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("categorieslist.php"); // Return to list
			}
		}
	}
