...
class users_edit extends users
{
	...
	protected function validateForm()
	{
		...
		if (in_array("userprofiles", $detailTblVar) && $GLOBALS["userprofiles"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("userprofiles", $detailTblVar) && $GLOBALS["userprofiles"]->DetailEdit) {
						...
						$editRow = $GLOBALS["userprofiles_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("userprofiles", $detailTblVar)) {
				...
				if ($GLOBALS["userprofiles_grid"]->DetailEdit) {
					$GLOBALS["userprofiles_grid"]->CurrentMode = "edit";
					$GLOBALS["userprofiles_grid"]->CurrentAction = "gridedit";
