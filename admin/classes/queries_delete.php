 ...
 * Page class
 */
class queries_delete extends queries
{
	...
	// Page object name
	public $PageObjName = "queries_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("querieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("querieslist.php"); // Return to list
			}
		}
	}
