 ...
 * Page class
 */
class locations_delete extends locations
{
	...
	// Page object name
	public $PageObjName = "locations_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("locationslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("locationslist.php"); // Return to list
			}
		}
	}
