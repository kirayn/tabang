 ...
 * Page class
 */
class userprofiles_grid extends userprofiles
{
	...
	// Page object name
	public $PageObjName = "userprofiles_grid";

	// Grid form hidden field names
	public $FormName = "fuserprofilesgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function renderListOptions()
	{
		...
		if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex)) {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->profileId->CurrentValue . "\">";
		}
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->profileId->CurrentValue = strval($arKeys[0]); // profileId
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
