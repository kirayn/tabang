	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("mediaId") !== NULL) {
				...
				$this->setKey("mediaId", $this->mediaId->CurrentValue); // Set up key
			} else {
				$this->setKey("mediaId", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "mediaview.php")
