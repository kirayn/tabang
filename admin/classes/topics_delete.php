 ...
 * Page class
 */
class topics_delete extends topics
{
	...
	// Page object name
	public $PageObjName = "topics_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("topicslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("topicslist.php"); // Return to list
			}
		}
	}
