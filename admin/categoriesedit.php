...
fcategoriesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($categories_edit->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($categories_edit->parentId->Required) { ?>
		...
		<?php } ?>
		<?php if ($categories_edit->image->Required) { ?>
...
fcategoriesedit.lists["x_parentId"] = <?php echo $categories_edit->parentId->Lookup->toClientList() ?>;
fcategoriesedit.lists["x_parentId"].options = <?php echo JsonEncode($categories_edit->parentId->lookupOptions()) ?>;
...
<?php if ($categories->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_categories_name" for="x_name" class="<?php echo $categories_edit->LeftColumnClass ?>"><?php echo $categories->name->caption() ?><?php echo ($categories->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categories_edit->RightColumnClass ?>"><div<?php echo $categories->name->cellAttributes() ?>>
...
<?php if ($categories->parentId->Visible) { // parentId ?>
	<div id="r_parentId" class="form-group row">
		<label id="elh_categories_parentId" for="x_parentId" class="<?php echo $categories_edit->LeftColumnClass ?>"><?php echo $categories->parentId->caption() ?><?php echo ($categories->parentId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categories_edit->RightColumnClass ?>"><div<?php echo $categories->parentId->cellAttributes() ?>>
...
<?php if ($categories->image->Visible) { // image ?>
	<div id="r_image" class="form-group row">
		<label id="elh_categories_image" class="<?php echo $categories_edit->LeftColumnClass ?>"><?php echo $categories->image->caption() ?><?php echo ($categories->image->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categories_edit->RightColumnClass ?>"><div<?php echo $categories->image->cellAttributes() ?>>
...
<?php
	if (in_array("adverts", explode(",", $categories->getCurrentDetailTable())) && $adverts->DetailEdit) {
?>
