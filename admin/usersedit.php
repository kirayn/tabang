...
fusersedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($users_edit->mobile->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_edit->emailid->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_edit->passcode->Required) { ?>
		...
		<?php if ($users_edit->activation->Required) { ?>
...
fusersedit.lists["x_role"] = <?php echo $users_edit->role->Lookup->toClientList() ?>;
...
<?php if ($users->mobile->Visible) { // mobile ?>
	<div id="r_mobile" class="form-group row">
		<label id="elh_users_mobile" for="x_mobile" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->mobile->caption() ?><?php echo ($users->mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($users->emailid->Visible) { // emailid ?>
	<div id="r_emailid" class="form-group row">
		<label id="elh_users_emailid" for="x_emailid" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->emailid->caption() ?><?php echo ($users->emailid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($users->passcode->Visible) { // passcode ?>
	<div id="r_passcode" class="form-group row">
		<label id="elh_users_passcode" for="x_passcode" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->passcode->caption() ?><?php echo ($users->passcode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->passcode->cellAttributes() ?>>
...
<?php if ($users->role->Visible) { // role ?>
	<div id="r_role" class="form-group row">
		<label id="elh_users_role" for="x_role" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->role->caption() ?><?php echo ($users->role->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->role->cellAttributes() ?>>
...
<?php if ($users->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_users_status" for="x_status" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->status->caption() ?><?php echo ($users->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($users->activation->Visible) { // activation ?>
	<div id="r_activation" class="form-group row">
		<label id="elh_users_activation" for="x_activation" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->activation->caption() ?><?php echo ($users->activation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->activation->cellAttributes() ?>>
...
<?php
	if (in_array("userprofiles", explode(",", $users->getCurrentDetailTable())) && $userprofiles->DetailEdit) {
?>
...
<?php } ?>
<?php
	if (in_array("adverts", explode(",", $users->getCurrentDetailTable())) && $adverts->DetailEdit) {
?>
<?php if ($users->getCurrentDetailTable() <> "") { ?>
